...
* [x] In potrait mode, the YouTubePlayerActivity also displays a list of related you tube videos. Used google API to achieve this.
...
* [x] The Genymotion emulator became very slow after installing GooglePlay services.
* [x] Had issue effectively using YouTubePlayerFragment. I couldn't get it to close after its instantiated.
